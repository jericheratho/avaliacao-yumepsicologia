    ...
    <section id="sobre" className="section-padding" ref={ref}>
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-5">
          {/* Card 1: Bio with circular photo */}
          <div className={`glass-card p-8 md:p-10 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            <div className="flex items-center gap-5 mb-6">
              <div className="relative group shrink-0">
                <div className="absolute -inset-2 rounded-full bg-gradient-to-br from-primary/30 via-sage/20 to-accent/30 blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-700" />
                <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-primary/10 via-transparent to-sage-light/20 blur-sm" />
                <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden shadow-[0_10px_30px_-8px_hsla(102,32%,41%,0.25)]">
              ...
              <div>
                <p className="editorial-label mb-1">Sobre mim</p>
                <h2 className="text-2xl md:text-3xl font-serif font-light text-foreground">
                  Ezequias Alves
                </h2>
                <p className="text-[13px] font-sans text-primary">Neuropsicólogo · CRP 03/24172</p>
              </div>
            </div>
