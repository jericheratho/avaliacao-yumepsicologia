...
const FaqSection = () => {
  ...
  return (
    <section id="duvidas" className="section-padding">
      <div className="max-w-5xl mx-auto">
        <p className="text-xs font-sans uppercase tracking-[0.3em] text-primary/60 mb-4">Dúvidas</p>
        <h2 className="text-4xl md:text-5xl font-serif font-light text-foreground mb-4">
          Suas dúvidas
        </h2>
        <p className="text-muted-foreground font-sans font-light max-w-xl leading-relaxed mb-4">
          O medo não some antes da decisão. Ele vem junto. E tudo bem ter medo.
        </p>
        <p className="text-foreground/60 font-sans font-light text-sm italic mb-16">
