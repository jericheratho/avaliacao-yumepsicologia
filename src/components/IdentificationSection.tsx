      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-5">
          ...
          <div className="md:col-span-7 flex flex-col gap-5">
            <div className={`glass-card p-8 md:p-10 transition-all duration-700 delay-100 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              {questions.map((q, i) => (
            ...
            <div className={`glass-card p-8 md:p-10 !bg-primary/80 !backdrop-blur-xl !border-primary/20 transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
